        ...
        <div class="card">
            <div class="card-header">
                ...
                <div class="card-tools">
                    ...
                    <a href="/setting/menus/create" class="btn btn-primary btn-sm"> 
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td style="text-align:center;">
                                        <a href="/setting/menus/delete/{{$d->id}}" class="btn btn-danger btn-sm">
                                            <i class="fa fa-trash"></i> HAPUS
                                        </a>   
                                        <a href="/setting/menus/edit/{{$d->id}}" class="btn btn-success btn-sm">
