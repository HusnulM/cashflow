            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="card-tools">                        
                        <a href="/setting/menus" class="btn btn-danger btn-sm"> 
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-md-12">
                            <div class="form-group">
                                <label for="rolename">Nama Menu</label>
                                <input type="text" name="menuname" class="form-control" autocomplete="off" required>
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-12">
                            <div class="form-group">
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12">
                            <div class="form-group">
                                ...
                                <input type="text" name="menuroute" class="form-control" autocomplete="off" required>
                            </div>
                        </div>
                    </div>
                </div>
