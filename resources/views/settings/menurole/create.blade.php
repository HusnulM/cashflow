    ...
    <div class="col-lg-12 mt-2">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">Tambah Menu Role</h3>
                            ...
                            <div class="form-group">
                                <div class="input-group">
                                    ...
                                    <span class="input-group-btn">
                                        <button type="button" class="btn btn-primary btn-sm" id="btn-select-role" style="height: 35px;margin-top: 0;">PILIH ROLE</button>
                                    </span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-12">
                            <table class="table table-striped table-bordered" style="width:100%">
                                <thead>
                                    ...
                                    <th style="width:150px;">ID Menu</th>
                                    <th>Nama Menu</th>
                                    <th></th>
                                </thead>
