...
@section('content')
<form action="{{ url('transaksi/pemasukan/save') }}" method="post" enctype="multipart/form-data">
    @csrf
    <div class="row">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="form-group">
                                <label for="tglPemasukan">Tanggal Pemasukan</label>
                                <input type="date" name="tglPemasukan" class="form-control" value="<?= date('Y-m-d'); ?>">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <select name="rekening" id="rekening" class="form-control">
                                    @foreach($bank as $b)
                                    <option value="{{ $b->bank_accountnumber }}">{{ $b->bank_accountname }} - {{ $b->bank_accountnumber }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="jmlPemasukan" class="form-control" required>
                            </div>
                        </div>                      
                    </div>
                    <div class="row">
