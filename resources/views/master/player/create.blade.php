...
@section('content')
<form action="{{ url('master/player/save') }}" method="post">
    @csrf
    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-12">
                            <div class="col-lg-12 col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="idplayer" class="form-control" autocomplete="off" required>
                                </div>
                            </div>
                            <div class="col-lg-12 col-md-12">
                                <div class="form-group">
                                    <label for="namaplayer">Nama Player</label>
                                    <input type="text" name="namaplayer" class="form-control" autocomplete="off" required>
                                </div>
                            </div>
