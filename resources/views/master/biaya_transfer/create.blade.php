...
@section('content')
<form action="{{ url('master/biayaadmin/save') }}" method="post">
    @csrf
    <div class="row">
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="card-tools">                        
                        <a href="/master/biayaadmin" class="btn btn-danger btn-sm"> 
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-12">
                            <div class="form-group">
                                ...
                                <input type="text" name="biaya_adm" class="form-control" required>
                            </div>
                        </div>
                    </div>
                </div>
