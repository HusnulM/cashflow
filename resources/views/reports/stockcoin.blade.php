...
@section('title', 'Laporan Stock Coin')
    ...
    <div class="col-lg-12 mt-2">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">Laporan Stock Coin</h3>
                        ...
                        <table id="tbl-users" class="table table-bordered table-striped table-hover table-sm">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $d->bankcode }}</td>
                                    <td>{{ $d->bankacc }}</td>
                                    <td style="text-align:right;">{{ number_format($d->totalcoin,0,'.',',') }}</td>
                                </tr>
                                @endforeach
                            </tbody>
                        </table>
